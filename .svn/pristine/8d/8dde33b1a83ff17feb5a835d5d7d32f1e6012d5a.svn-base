...
public class QRCode {
	...
	public static boolean[] orientation_mask = {true,true, true, true, true, true, true,
	...
	public static boolean[] alignment_mask = {true,true ,true ,true ,true,
...
//		throw new IllegalStateException();
	...
	public static FormatInformation check_format(boolean[][] data) {
		int index = 0;
		//Format obenLinks
